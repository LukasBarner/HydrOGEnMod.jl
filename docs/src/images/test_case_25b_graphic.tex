...
\begin{document}
	\begin{tikzpicture}[domain=0:2, scale=5]		
		\filldraw[color=gray, opacity = 0.5] (0,0.5) -- (0,2)  -- (0.5,1.5) -- (0.5,1) -- (0.25,1) -- (0.25,0.5);		
		...
		\draw (0,0.5)--(0.25,0.5) node[right]{};
		\draw (0.25,1.0)--(1.5,1.0) node[right] {$MC$};
		\draw (0,2)--(1,0) node[above right] {$MR$};
		\draw [dashed, color=gray] (0.5,0) -- (0.5,2);
		\draw [dashed, color=gray] (0.25,0) -- (0.25,0.5);
	\end{tikzpicture}
\end{document}